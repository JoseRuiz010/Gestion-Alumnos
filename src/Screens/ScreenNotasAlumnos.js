...
export const ScreenNotasAlumnos = () => {
    ...
    return (
        <div class="flex pb-7 flex-col mt-3 px-2 w-full max-w-7xl mx-auto  ">
            <div class="grid mb-3 grid-cols-2 w-full mx-auto md:grid-cols-3 p-3 md:w-10/12 gap-2 card bg-base-200 rounded-box">
            ...
            <div class="mt-1 card rounded-box place-items-center">
